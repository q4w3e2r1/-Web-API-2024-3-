...
def get_products():
    ...
    """
    headers = {
        'accept': 'application/json, text/plain, */*',  # Устанавливаем заголовки для запроса
        'user-agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/129.0.0.0 Safari/537.36 Edg/129.0.0.0',  # Указываем User-Agent
    }
